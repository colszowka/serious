...
delimiter "~", so Serious knows what you want. You can change the summary delimiter in your configuration.
...
default this value is '~', but can be customized as well:
