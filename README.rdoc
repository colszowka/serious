...
Serious is a blog engine inspired by other filesystem-based engines like jekyll[link:http://jekyllrb.com/] 
and toto[link:http://cloudhead.io/toto], but is based upon Sinatra and rack and thus can be hosted
very easily (and for free) on heroku[link:http://heroku.com].
...
Serious makes use of StupidFormatter[link:http://github.com/colszowka/stupid_formatter] for formatting
...
stupid_formatter}[link:http://rdoc.info/projects/colszowka/stupid_formatter] to learn how to 
...
visitor's browsers as well as in {Varnish on Heroku}[link:http://docs.heroku.com/http-caching] 
...
You'll surely want to read the documentation of StupidFormatter[link:http://github.com/colszowka/stupid_formatter]
